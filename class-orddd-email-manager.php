...
class ORDDD_Email_Manager {
	...
	public function orddd_init_emails( $emails ) {
	    ...
	    if ( ! isset( $emails[ 'ORDDD_Email_Delivery_Reminder' ] ) ) {
	        $emails[ 'ORDDD_Email_Delivery_Reminder' ] = include( 'emails/class-orddd-email-delivery-reminder.php' );
		}
		
		if ( ! isset( $emails[ 'ORDDD_Email_Admin_Delivery_Reminder' ] ) ) {
	        $emails[ 'ORDDD_Email_Admin_Delivery_Reminder' ] = include( 'emails/class-orddd-admin-delivery-reminder.php' );
	    }
	    return $emails;
	}
