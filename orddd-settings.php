    ...
    */ 
    ...
    public  function orddd_time_slot_settings() {
        ...
        add_settings_field(
            ...
            'orddd_time_slot_page',
            'orddd_add_time_slot_section',
            array( __( 'A time slot will become unavailable for further deliveries once these many orders are placed for delivery for that time slot.', 'order-delivery-date' ) )
        );
    ...
    public function orddd_shipping_based_settings_callback() {
        ...
        add_settings_field(
            ...
            'orddd_shipping_based_page',
            'orddd_shipping_based_date_settings_section',
            array ( __( 'A date will become unavailable for further deliveries once these many orders are placed for delivery for that date.<br><i>Note: Leave the field blank if the Maximum Order Deliveries from General Settings -> Date Settings link should be considered.</i>', 'order-delivery-date' ) )
        );
    ...
    public function orddd_calendar_sync_settings_callback() {
        ...
        add_settings_field(
            ...
            'orddd_calendar_sync_settings_page',
            'orddd_calendar_sync_general_settings_section',
            array ( __( '<br>Enter the text that will be used in the location field of the calendar event. If left empty, the website description will be used. <br><i>Note: You can use ADDRESS, FULL_ADDRESS and CITY placeholders which will be replaced by their real values.</i>', 'order-delivery-date' ) )
        );
        ...
        add_settings_field(
            ...
            'orddd_calendar_sync_settings_page',
            'orddd_calendar_sync_general_settings_section',
            array( __( '<br>For the above 2 fields, you can use the following placeholders which will be replaced by their real values:&nbsp;SITE_NAME, CLIENT, PRODUCTS, PRODUCT_WITH_QTY, ORDER_DATE_TIME, ORDER_DATE, ORDER_NUMBER, PRICE, PHONE, NOTE, ADDRESS, FULL_ADDRESS , EMAIL (Client\'s email)	', 'order-delivery-date' ) )
        );
