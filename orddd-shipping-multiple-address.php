    ...
    function orddd_remove_checkout_fields( $fields ) {
        if ( function_exists( 'wcms_session_get' ) ) {
            ...
            if ( $sess_cart_addresses && !empty( $sess_cart_addresses ) ) {
                ...
                remove_action( 'woocommerce_checkout_process', array( 'orddd_process', 'orddd_validate_date' ) );
                remove_action( 'woocommerce_checkout_process', array( 'orddd_process', 'orddd_validate_time_slot' ) );
