...
update_option('edd_sample_license_key_odd_woo', 'NULLED-BY-GANJAPARKER'); 
update_option('edd_sample_license_status_odd_woo', 'valid'); 
...
$edd_updater = new EDD_SL_Plugin_Updater(
	...
	__FILE__,
	array(
		'version'   => '9.16.0',        // current version number.
